...
import com.mql.notesProject.exceptions.FileStorageException;
import com.mql.notesProject.exceptions.FileNotFoundException;
...
public class FileStorageService {
    ...
    public String storeFile(MultipartFile file) {
        ...
        String fileName = StringUtils.cleanPath(name+"-"+(new SimpleDateFormat("ddMMyy-hhmmss")).format(new Date())+"."+extension);
